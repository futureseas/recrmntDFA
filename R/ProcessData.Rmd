...
datFiles <- datFiles[-which(datFiles %in% c("Anchovy_Sardine_len_wt_age.csv", 
                                            ...
                                            "sswi_monthly_35-37N_1980-2010.csv"))]
...
```{r}
# aggregate over time
by_t <- as.POSIXct(c("0099-01-01", "0123-01-01"))
...
plot(sardSpGrdNum/sardSpGrdDenom, type = "l")
abline(h = quantile(sardSpGrdNum/sardSpGrdDenom, probs = c(0.1, 0.2, 0.5)))
...
plot(anchSpGrdNum/anchSpGrdDenom, type = "l")
abline(h = quantile(anchSpGrdNum/anchSpGrdDenom, probs = c(0.2, 0.5)))
```
